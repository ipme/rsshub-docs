...
Do not list another developer's GitHub ID in the `maintainers` field of an route unless they have explicitly agreed. Only list GitHub IDs that belong to you or to contributors who have given you permission.
